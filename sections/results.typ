...
#figure(
  ...
  caption: [Direct vs tree force runtime and energy drift (Plummer sphere, leapfrog, $theta = 0.75$). Direct summation is faster but accumulates substantially more energy drift, particularly at large $N$.],
) <tab:crossover>
